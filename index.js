        ...
        if (!err) {
            ...
            <body class="site">
                ...
                <nav>
                    <ul class="local">
                        <li>
                            <a class="btn btn-neon" title="Acessar Perfil" href="http://localhost:8081/listar">ACESSAR
                                PERFIL</a>
                        </li>
                    </ul>
                </nav>
...
<body class="site">
    ...
    <div class="site-content bg2">
        <nav>
            <ul class="local">
                <li>
                    <a class="btn btn-neon" title="Criar Perfil" href="http://localhost:8081/cadastro">CRIAR
                        PERFIL</a>
                </li>
                <li>
                    <a class="btn btn-neon" title="Acessar Perfil" href="http://localhost:8081/listar">ACESSAR
